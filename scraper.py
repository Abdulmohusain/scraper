...
# def scrape_and_append(soup, url):
#     # global review, prep_time, cook_time,total_time,servings,yield_,ingredients,directions
#     recipie_name = soup.find('h1').text
#     try:
#         review = soup.find('div', {'id': 'mntl-recipe-review-bar__comment-count_1-0'}).text.replace('Reviews', '').strip()
#     except AttributeError:
#         pass
#         review = None
#         print(f'No review for this link {url}')
#     all_details = soup.find_all('div', 'mntl-recipe-details__value')
#     for i in range(6):
#         if i == 0:
#             try:
#                 prep_time = all_details[0].text
#             except IndexError:
#                 prep_time = None
#                 print(f'No Prep time for this link {url}')
#         if i == 1:
#             try:
#                 cook_time = all_details[1].text
#             except IndexError:
#                 cook_time = None
#                 print(f'No cook time for this link {url}')
#         if i == 2:
#             try:
#                 total_time = all_details[2].text
#             except IndexError:
#                 total_time = None
#                 print(f'No total time for this link {url}')
#         if i == 3:
#             try:
#                 servings = all_details[3].text
#             except IndexError:
#                 servings = None
#                 print(f'No servings for this link {url}')
#         if i == 4:
#             try:
#                 yield_ = all_details[4].text.replace('servings', '')
#             except IndexError:
#                 yield_ = None
#                 print(f'No yield for this link {url}')
#
#     try:
...
#         print(f'No yield for this link {url}')
#     try:
#         directions = soup.find('ol', {'id': 'mntl-sc-block_2-0'}).text
#     except AttributeError:
#         directions = None
#         print(f'No directions for this link {url}')
#     dict_data = {
